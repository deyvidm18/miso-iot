...
void loop()
{
  ...
  */
  ...
  //JSON para temperatura
  json = "{\"value\": "+ String(V) + ", \"description\": "+  (V < 10 ? "\"Sin luz\"" : (V < 200 ? "\"Luz tenue\"" : (V < 500  ? "\"Luz\"" : (V < 800  ? "\"Luz brillante\"" : "\"Luz muy brillante\""))))  + "}";
